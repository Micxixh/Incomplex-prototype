...
import svgPaths from "../imports/svg-xx99u8cico";
...
interface ClickableLogoGridProps {
...
function Frame4({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
    >
...
function Frame2({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame7({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[187px]'}`}
    >
      <div aria-hidden="true" className="absolute border-[6px] border-black border-solid inset-[-6px] pointer-events-none rounded-[16px]" />
...
function Frame({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[187px]'}`}
...
function Frame9({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame10({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame11({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame12({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame1({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[187px]'}`}
...
function Frame5({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[187px]'}`}
...
function Frame8({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
function Frame6({ onClick, isMobile }: { onClick: () => void; isMobile: boolean }) {
  return (
    <button
      onClick={onClick}
      className={`bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 hover:scale-105 transition-transform duration-200 cursor-pointer ${isMobile ? 'w-full' : 'w-[188px]'}`}
...
export default function ClickableLogoGrid({ onLogoClick }: ClickableLogoGridProps) {
  ...
  return (
    <div className={isMobile ? "grid grid-cols-2 gap-[12px] relative shrink-0 w-full" : "content-center flex flex-wrap gap-[12px] items-center justify-center relative shrink-0 w-full"}>
      <Frame4 onClick={() => onLogoClick(companyNames[0])} isMobile={isMobile} />
      <Frame2 onClick={() => onLogoClick(companyNames[1])} isMobile={isMobile} />
      <Frame7 onClick={() => onLogoClick(companyNames[2])} isMobile={isMobile} />
      <Frame onClick={() => onLogoClick(companyNames[3])} isMobile={isMobile} />
      <Frame9 onClick={() => onLogoClick(companyNames[4])} isMobile={isMobile} />
      <Frame10 onClick={() => onLogoClick(companyNames[5])} isMobile={isMobile} />
      <Frame11 onClick={() => onLogoClick(companyNames[6])} isMobile={isMobile} />
      <Frame12 onClick={() => onLogoClick(companyNames[7])} isMobile={isMobile} />
      <Frame1 onClick={() => onLogoClick(companyNames[8])} isMobile={isMobile} />
      <Frame5 onClick={() => onLogoClick(companyNames[9])} isMobile={isMobile} />
      <Frame8 onClick={() => onLogoClick(companyNames[10])} isMobile={isMobile} />
      <Frame6 onClick={() => onLogoClick(companyNames[11])} isMobile={isMobile} />
    </div>
  );
}
