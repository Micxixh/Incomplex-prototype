import svgPaths from "./svg-xx99u8cico";
...
function Frame4() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 w-[188px]">
      <Natwest />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[10px] h-[70px] items-center justify-center p-[12px] relative rounded-[10px] shrink-0 w-[187px]">
...
export default function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-center relative size-full">
      <Frame3 />
    </div>
  );
}