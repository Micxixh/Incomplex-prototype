import svgPaths from "./svg-27nvw21bkg";
...
export default function Frame3() {
  return (
    <div className="gap-[20px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)] relative size-full">
      <Frame4 />
      <Frame2 />
      <Frame7 />
      <Frame />
