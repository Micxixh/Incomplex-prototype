import svgPaths from "./svg-p25raekxkv";
...
function Frame5() {
  return (
    <div className="absolute bottom-[31px] content-stretch flex gap-[10px] items-center left-0 w-[375px]">
      <Frame12 />
    </div>
  );
}
...
export default function OurDnaSection() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[24px] items-start justify-center px-0 py-[24px] relative size-full" data-name="Our DNA section">
      <Header />
      <div className="h-[559.5px] relative shrink-0 w-[375px]">
