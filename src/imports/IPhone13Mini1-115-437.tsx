import svgPaths from "./svg-m8vo6vpggj";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[270px]">
      <div className="basis-0 flex flex-col font-['Roboto_Condensed:ExtraBold',_sans-serif] font-extrabold grow justify-end leading-[0] min-h-px min-w-px relative shrink-0 text-[48px] text-white uppercase">
  ...
  return (
    <div className="relative rounded-tl-[24px] rounded-tr-[24px] shrink-0 w-full" data-name="Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center p-[24px] relative w-full">
          <Frame />
        </div>
      </div>
    </div>
...
function Frame4() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[24px] h-[508px] items-center px-[24px] py-[48px] relative rounded-[24px] shrink-0 w-[315px]">
      <div aria-hidden="true" className="absolute border-[#00303f] border-[12px] border-solid inset-0 pointer-events-none rounded-[24px]" />
...
function Frame14() {
  return (
    <div className="content-stretch flex gap-[12px] h-[560px] items-center relative shrink-0 w-[327px]">
      <Frame4 />
      <Frame5 />
      <Frame6 />
    </div>
...
function Frame15() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-[375px]">
      <Frame14 />
    </div>
  );
}
...
function WeSeeYouSection() {
  return (
    <div className="relative shrink-0 w-full" data-name="We see you section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-center p-[24px] relative w-full">
          <div className="absolute h-[601px] left-0 top-[104px] w-[375px]">
...
function Frame3() {
  return (
    <div className="gap-[12px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)] h-[480px] relative shrink-0 w-full">
      <Frame17 />
      <Frame18 />
      <Frame7 />
      <Frame19 />
...
function Frame67() {
  return (
    <div className="bg-[#00303f] box-border content-stretch flex flex-col gap-[10px] h-[290px] items-center justify-center p-[24px] relative rounded-[12px] shrink-0 w-[298px]">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <Frame38 />
      <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[24px] text-nowrap text-white uppercase whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>{`Strategic Thinking `}</p>
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[1.5] min-w-full not-italic relative shrink-0 text-[#d0fffb] text-[16px] w-[min-content]">{`We don’t just execute tasks — we think like partners, helping shape the best technical direction for your goals. `}</p>
...
function OurDnaSection() {
  return (
    <div className="relative shrink-0 w-full" data-name="Our DNA section">
...
function Frame82() {
  return (
    <div className="bg-[#00303f] box-border content-stretch flex flex-col gap-[10px] h-[488px] items-center justify-center p-[24px] relative rounded-[12px] shrink-0 w-[326px]">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <Frame81 />
      <div className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[24px] text-center text-nowrap text-white uppercase whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame83() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-start justify-center px-[24px] py-0 relative w-full">
          <div className="absolute h-[573px] left-0 top-[107.5px] w-[375px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 573">
              <path d={svgPaths.pd2b0c80} fill="var(--fill-0, white)" id="Rectangle 46" />
            </svg>
          </div>
          <Header4 />
          <Frame59 />
...
function Frame84() {
  return (
    <div className="bg-[#00303f] h-[117px] relative rounded-[12px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[117px] items-center justify-center p-[24px] relative w-full">
          <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[16px] text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
  ...
  return (
    <div className="bg-[#00303f] h-[117px] relative rounded-[12px] shrink-0 w-full">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[117px] items-center justify-center p-[24px] relative w-full">
          <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[16px] text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            “What if I don’t know exactly what I need, just that something’s not working? ”
          </p>
        </div>
      </div>
    </div>
...
function Frame86() {
  return (
    <div className="bg-[#00303f] h-[120px] relative rounded-[12px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[120px] items-center justify-center p-[24px] relative w-full">
          <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[16px] text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame87() {
  return (
    <div className="bg-[#00303f] h-[118px] relative rounded-[12px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[118px] items-center justify-center p-[24px] relative w-full">
          <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[16px] text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            “Can you help us hit a critical deadline or recover a project that’s off-track?”
          </p>
        </div>
      </div>
    </div>
...
function Frame88() {
  return (
    <div className="bg-[#00303f] h-[121px] relative rounded-[12px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[12px] border-solid border-white inset-[-12px] pointer-events-none rounded-[24px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[121px] items-center justify-center p-[24px] relative w-full">
          <p className="font-['Roboto:SemiBold',_sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[16px] text-white w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            “What coding language / tech stack do you work with ?”
          </p>
        </div>
      </div>
    </div>
...
function Frame89() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-[316px]">
      <Frame84 />
      <Frame85 />
      <Frame86 />
      <Frame87 />
...
function Frame90() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[48px] items-center pl-[6px] pr-[36px] py-0 relative w-full">
          <Frame89 />
        </div>
      </div>
    </div>
...
function Frame55() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[36px] items-start justify-center pb-[24px] pt-0 px-[24px] relative w-full">
          <div className="absolute h-[742.5px] left-0 top-[54px] w-[375px]">
